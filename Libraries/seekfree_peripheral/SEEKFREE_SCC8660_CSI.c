...
uint16 SCC8660_CFG_CSI[SCC8660_CONFIG_FINISH][2]=
{
    ...
    {SCC8660_COLOR_MODE,        1},                     //图像色彩模式 默认：0		可选参数为：0 1。         0：正常彩色模式    1：鲜艳模式（色彩饱和度提高）
    {SCC8660_DATA_FORMAT,       1},                     //输出数据格式 默认：0		可选参数为：0 1 2 3。     0：RGB565 1：RGB565(字节交换) 2：YUV422(YUYV) 3：YUV422(UYVY)
